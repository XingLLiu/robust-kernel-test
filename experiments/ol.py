...
if __name__ == "__main__":
    ...
    if args.gen == "True":
        ...
        X_res = pickle.load(open(os.path.join(SAVE_DIR, f"ol_X_res_n{args.n}_d{dim}.pkl"), "rb"))
        score_res = pickle.load(open(os.path.join(SAVE_DIR, f"ol_score_res_n{args.n}_d{dim}.pkl"), "rb"))
